...
model & query & given & using & case\_level & mean & sd & cred.low.2.5\% & cred.high.97.5\%\\
\hline
model\_1 & I = 0 caused D = 1 & I==0 \& D==1 & parameters & FALSE & 0.4384 &  & 0.4384 & 0.4384\\
\hline
model\_1 & I = 0 caused D = 1 & I==0 \& D==1 \& M==0 & parameters & FALSE & 0.4750 &  & 0.4750 & 0.4750\\
\hline
model\_1 & I = 0 caused D = 1 & I==0 \& D==1 \& M==1 & parameters & FALSE & 0.3939 &  & 0.3939 & 0.3939\\
\hline
model\_1 & I = 0 caused D = 1 & I==0 \& D==1 \& P==0 & parameters & FALSE & 0.6154 &  & 0.6154 & 0.6154\\
\hline
model\_1 & I = 0 caused D = 1 & I==0 \& D==1 \& P==1 & parameters & FALSE & 0.3404 &  & 0.3404 & 0.3404\\
\hline
model\_1 & I = 0 caused D = 1 & I==0 \& D==1 \& M == 0 \& P==0 & parameters & FALSE & 0.6667 &  & 0.6667 & 0.6667\\
\hline
model\_1 & I = 0 caused D = 1 & I==0 \& D==1 \& M == 1 \& P==0 & parameters & FALSE & 0.5714 &  & 0.5714 & 0.5714\\
\hline
model\_1 & I = 0 caused D = 1 & I==0 \& D==1 \& M == 0 \& P==1 & parameters & FALSE & 0.3929 &  & 0.3929 & 0.3929\\
\hline
model\_1 & I = 0 caused D = 1 & I==0 \& D==1 \& M == 1 \& P==1 & parameters & FALSE & 0.2632 &  & 0.2632 & 0.2632\\
\hline
\end{tabular}
...
model & query & given & using & case\_level & mean & sd & cred.low.2.5\% & cred.high.97.5\%\\
\hline
model\_1 & I = 1 caused D = 1 & I==1 \& D==1 & parameters & FALSE & 0.1277 &  & 0.1277 & 0.1277\\
\hline
model\_1 & I = 1 caused D = 1 & I==1 \& D==1 \& M==0 & parameters & FALSE & 0.0000 &  & 0.0000 & 0.0000\\
\hline
model\_1 & I = 1 caused D = 1 & I==1 \& D==1 \& M==1 & parameters & FALSE & 0.1500 &  & 0.1500 & 0.1500\\
\hline
model\_1 & I = 1 caused D = 1 & I==1 \& D==1 \& P==0 & parameters & FALSE & 0.2308 &  & 0.2308 & 0.2308\\
\hline
model\_1 & I = 1 caused D = 1 & I==1 \& D==1 \& P==1 & parameters & FALSE & 0.0882 &  & 0.0882 & 0.0882\\
\hline
\end{tabular}
